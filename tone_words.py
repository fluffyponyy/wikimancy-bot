negative = [
    "doom", "suffering", "despair", "failure", "decay", "misery", "regret", "loss", "pain", "misfortune",
    "tragedy", "collapse", "betrayal", "conflict", "chaos", "ruin", "grief", "agony", "fear", "darkness",
    "scorn", "anguish", "bitterness", "gloom", "desolation", "abandonment", "frustration", "peril", "hazard",
    "heartache", "deprivation", "oblivion", "dread", "affliction", "misdeed", "corruption", "turmoil", "anguishing", "lament",
    "affliction", "struggle", "painfulness", "misgiving", "defeat", "sorrow", "doomfulness", "losses", "grievance", "ruination",
    "nightmare", "miserys", "misfortuneous", "blight", "hardship", "crisis", "desperation", "woe", "catastrophe", "disaster",
    "calamity", "collapse", "failureing", "trouble", "menace", "turmoil", "fearfulness", "trauma", "oppression",
    "anguishedness", "decayings", "desperateness", "malady", "curse", "punishment", "hazardousness", "doomful", "grievousness",
    "defilement", "destructiveness", "perdition", "misadventure", "a debt you owe the universe", "unrest", "pitfall", "malice", "torment", "bleakness",
    "distress", "danger", "wretchedness", "heartbreak", "disillusion", "sadness", "war", "troublement", "miseryed", "shame"
]
...
positive = [
    "cheer", "joy", "happiness", "delight", "gladness", "bliss", "contentment", "ecstasy", "elation", "jubilation",
